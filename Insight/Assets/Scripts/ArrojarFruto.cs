...
public class ArrojarFruto : MonoBehaviour
{
	...
	public int frutosDisponibles = 3; // Cantidad de frutos disponibles en el nivel
	new Camera camera;
    ...
    // Este método arroja la bola
        ...
        {
            if (other.gameObject.tag == "checkpoint") // Si el gameobject es un ball (tag)
            {
                frutosDisponibles += 5;
            }
        }
